    ...
    return function (WrappedComponent) {
        ...
        return _dec = (0, _reactRedux.connect)(function (state) {
            ...
            function DataLoader() {
                ...
                return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DataLoader.__proto__ || Object.getPrototypeOf(DataLoader)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
                    data: null,
                    error: false
            ...
            _createClass(DataLoader, [{
                ...
                value: function componentDidUpdate(prevProps) {
                    if (prevProps.focusedNodeContextPath !== this.props.focusedNodeContextPath || !(0, _lodash2.default)(prevProps.options.arguments, this.props.options.arguments)) {
                        this.fetchData();
                    }
                }
            }, {
                ...
                value: function fetchData() {
                    ...
                    var dataSourceAdditionalData = Object.assign({ node: this.props.focusedNodeContextPath }, this.props.options.arguments);
                    ...
                    this.props.dataSourcesDataLoader.resolveValue({
                        ...
                        dataSourceAdditionalData: dataSourceAdditionalData
                ...
                value: function getContent() {
                    if (this.state.error) {
                        return _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement(_reactUiComponents.Icon, { icon: 'exclamation-triangle', className: _style2.default.warnIcon }),
                            ' ',
                    ...
                    if (!this.state.data) {
                        return _react2.default.createElement(
                            'div',
                            null,
                            this.props.i18nRegistry.translate("Neos.Neos:Main:loading")
                        );
                    }
...
var ColumnView = (_dec = (0, _index2.default)(), _dec(_class = (_temp = _class2 = function (_PureComponent) {
    _inherits(ColumnView, _PureComponent);

    function ColumnView() {
        _classCallCheck(this, ColumnView);

        return _possibleConstructorReturn(this, (ColumnView.__proto__ || Object.getPrototypeOf(ColumnView)).apply(this, arguments));
    }
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        { 'class': [_style2.default.bar__legend, _style2.default.bar__left].join(' '), style: { width: low + '%' } },
                        thresholdMin,
                        unit,
                        '\xA0\u203A'
                    ),
                    _react2.default.createElement('span', { 'class': [_style2.default.bar__legend, _style2.default.bar__middle].join(' '), style: { width: medium + '%' } }),
                    _react2.default.createElement(
                        'span',
                        { 'class': [_style2.default.bar__legend, _style2.default.bar__right].join(' '), style: { width: high + '%' } },
                        '\u2039\xA0',
                        thresholdMax,
                        unit
                    )
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'span',
                        { 'class': [_style2.default.bar__section, _style2.default.bar__low].join(' '), style: { width: low + '%' } },
                        low,
                        '%'
                    ),
                    _react2.default.createElement(
                        'span',
                        { 'class': [_style2.default.bar__section, _style2.default.bar__medium].join(' '), style: { width: medium + '%' } },
                        medium,
                        '%'
                    ),
                    _react2.default.createElement(
                        'span',
                        { 'class': [_style2.default.bar__section, _style2.default.bar__high].join(' '), style: { width: high + '%' } },
                        high,
                        '%'
                    )
                ),
...
// extracted by mini-css-extract-plugin
module.exports = {"widget":"_2Hy30PN-Mki80v17lTWc7h","header":"_14NUpWkoadYOmbkWkiIOOH","body":"_2Ti5z2RN6P7LZ2__6QewRm","label":"_1c1xzWNsYMU_GFmI5LOnvx","subtitle":"_1UmAS4GtMQRFjRqtXeH2d8"};
...
// extracted by mini-css-extract-plugin
module.exports = {"neos-module-wrap":"w5bv8xAObcnW_Crgn1rLF","widget-container":"gjtIo_OyCSMP8l-L--glB","widget-header":"_1CK6tuiVqFlF4Hei38wX-Y","widget-footer":"_1XdMfr5aD_mpSqBISyYNFc","infopanel":"_3AaPomTGZ_HMkIAH00ezZs","widget-desc":"_20zcnSu8NolUjvTLZYmfz8","bar-wrapper":"_1jl8nI7thUj8aHv10gGNnq","bar":"_3rPgQ3mXXXo8Av3Iy8xiSp","bar__legend":"_3O5QKDNvGx9KElRK78Wmwr","bar__section":"_2bifgprhVi4cU4TGI-gYoz","bar__left":"_3aJCBYymH4iS0LdoINEnG2","bar__right":"_3CCdT-zD854IJC62K7JS-w","bar__low":"UZG4gtncqZP2J-H-r4U-G","bar__medium":"_1xunHeOuVL7lG6kZd1fy8h","bar__high":"J-ZLkLqCnKjJgHV4D6Sq9","infopanel__date":"_1CxsvyzK23rdZUTDkkdV7O","infopanel__total":"LWY1UQ2wMmwic6ReNNcMo"};
