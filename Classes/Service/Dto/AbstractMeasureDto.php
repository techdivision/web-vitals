...
abstract class AbstractMeasureDto
{
     ...
     */
    public function setNumberOfLowMeasures(int $numberOfLowMeasures)
    {
     ...
     */
    public function setNumberOfMediumMeasures(int $numberOfMediumMeasures)
    {
     ...
     */
    public function setNumberOfHighMeasures(int $numberOfHighMeasures)
    {
     ...
     */
    public function setNumberOfTotalMeasures(int $numberOfTotalMeasures)
    {
